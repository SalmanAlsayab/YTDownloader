...
class YDLConfig(BaseModel):
    ...
    postprocessors: list = Field(default_factory=list, description="List of post-processors")
...
def download_audio_mp3(url: str, output_dir: str = 'audio') -> None:
    ...
    Args:
        ...
        output_dir: Directory to save the MP3 file (default: 'audio')
    """
...
def download_1440p(url: str) -> None:
...
def download_1080p(url: str) -> None:
...
def download_720p(url: str) -> None:
...
def download_480p(url: str) -> None:
...
def download_360p(url: str) -> None:
